		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPUI5 App",
									"targetURL": "#logalisapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logalisapui5-display": {
								"semanticObject": "logalisapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logali.sapui5",
									"url": sap.ui.require.toUrl("logali/sapui5")
								}
							}
						}
					}
